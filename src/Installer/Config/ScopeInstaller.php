...
class ScopeInstaller extends YamlEntityInstaller implements InstallerInterface, LoaderAwareInstaller, EntityInstallerInterface, SharingEntitiesInstallerInterface
{
    protected function getDataFilePath(): string
    {
        return 'config/scopes.yaml';
    }
}